...
export function Sidebar({ defaultOpen = true }) {
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="flex h-14 items-center justify-between px-2.5 border-b border-gray-200">
        <div className="flex items-center gap-2.5 overflow-hidden">
          <div className="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-lg bg-violet-600">
            {icons.bolt}
          </div>
          <span
            className={`
              whitespace-nowrap font-medium text-gray-900 transition-all duration-200
        ...
        <button
          ...
          className="
            ...
            hover:bg-gray-100 hover:text-gray-600 transition-colors duration-100
          "
        >
          <span
      ...
      {/* Nav content */}
      <div className="flex flex-col gap-1 flex-1 overflow-y-auto p-2 min-h-0">
        {/* Main section */}
        <p
          className={`
            px-2 pt-2 pb-1 text-[10px] font-semibold uppercase tracking-widest text-gray-400
        ...
        <p
          className={`
            px-2 pt-1 pb-1 text-[10px] font-semibold uppercase tracking-widest text-gray-400
            transition-opacity duration-200 ${isOpen ? "opacity-100" : "opacity-0"}
          `}
        >
          Settings
      ...
      {/* Footer / user card */}
      <div className="border-t border-gray-200 p-2.5 flex-shrink-0 overflow-hidden">
        <button
          className={`
            ...
            rounded-lg hover:bg-gray-50 transition-colors duration-100
          `}
        >
          <div
            className="
